...
macro(webview_init)
    ...
    if(WEBVIEW_IS_TOP_LEVEL_BUILD)
        ...
        if((CMAKE_C_COMPILER_ID MATCHES "((^GNU)|Clang)$") AND (CMAKE_CXX_COMPILER_ID MATCHES "((^GNU)|Clang)$"))
            ...
            add_compile_options($<$<BOOL:${WEBVIEW_HAS_NO_EXCEPTIONS}>:-fno-exceptions>)
        elseif(MSVC)
            ...
            add_compile_options($<$<BOOL:${WEBVIEW_HAS_NO_EXCEPTIONS}>:/EHs->)
        endif()
        add_compile_definitions($<$<BOOL:${WEBVIEW_HAS_NO_EXCEPTIONS}>:WEBVIEW_HAS_NO_EXCEPTIONS>)
...
macro(webview_internal_options)
    ...
    option(WEBVIEW_HAS_NO_EXCEPTIONS "Disable exceptions" OFF)
    option(WEBVIEW_STRICT_CHECKS "Make checks strict" ${WEBVIEW_IS_CI})
    cmake_dependent_option(WEBVIEW_BUILD_TESTS "Build WebView tests" ON "NOT WEBVIEW_HAS_NO_EXCEPTIONS" OFF)
