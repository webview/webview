...
macro(webview_internal_options)
    ...
    option(WEBVIEW_BUILD "Enable building" ${WEBVIEW_IS_TOP_LEVEL_BUILD})
    option(WEBVIEW_BUILD_DOCS "Build documentation" ${WEBVIEW_BUILD})
    option(WEBVIEW_BUILD_TESTS "Build tests" ${WEBVIEW_BUILD})
    option(WEBVIEW_BUILD_EXAMPLES "Build examples" ${WEBVIEW_BUILD})
    option(WEBVIEW_INSTALL_DOCS "Install documentation" ${WEBVIEW_BUILD_DOCS})
    option(WEBVIEW_INSTALL_TARGETS "Install targets" ${WEBVIEW_BUILD})
    option(WEBVIEW_BUILD_PACKAGE "Build package" ${WEBVIEW_BUILD})
