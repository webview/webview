...
function(webview_find_clang_format REQUIRED)
    if(DEFINED WEBVIEW_CLANG_FORMAT_EXE)
        set(CLANG_FORMAT_EXE_HINT "${WEBVIEW_CLANG_FORMAT_EXE}")
    else()
...
function(webview_find_clang_tidy REQUIRED)
    if(DEFINED WEBVIEW_CLANG_TIDY_EXE)
        set(WEBVIEW_CLANG_TIDY_EXE_HINT "${WEBVIEW_CLANG_TIDY_EXE}")
    else()
