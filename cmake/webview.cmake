    ...
    elseif(CMAKE_SYSTEM_NAME STREQUAL "Windows")
        ...
        if(WEBVIEW_QT)
            if("${WEBVIEW_QT}" STREQUAL "5")
                ...
                list(APPEND WEBVIEW_DEPENDENCIES PkgConfig::WEBVIEW_QT PkgConfig::WEBVIEW_QWEBENGINE dl)
                if (Qt5_POSITION_INDEPENDENT_CODE)
                    SET(CMAKE_POSITION_INDEPENDENT_CODE ON)
                endif()
            else()
                pkg_check_modules(WEBVIEW_QT REQUIRED IMPORTED_TARGET Qt6Core Qt6Gui Qt6Xml Qt6Network Qt6Qml Qt6DBus Qt6Widgets)
                pkg_check_modules(WEBVIEW_QWEBENGINE REQUIRED IMPORTED_TARGET Qt6WebEngineCore Qt6WebEngineWidgets)
                list(APPEND WEBVIEW_DEPENDENCIES PkgConfig::WEBVIEW_QT PkgConfig::WEBVIEW_QWEBENGINE dl)
                SET(CMAKE_POSITION_INDEPENDENT_CODE ON)
